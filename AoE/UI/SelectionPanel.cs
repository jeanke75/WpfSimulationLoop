...
namespace AoE.UI
{
    class SelectionPanel
    {
        ...
        {
            panelOffset = new Vector(89, window.GetHeight() - 90);
        ...
        public void Draw(DrawingContext dc, ISelectable selectable)
        {
            ...
            if (selectable is BaseGameObject selectedBaseGameObject)
            {
                ...
                dc.DrawText(nameText, new Point(panelOffset.X + xOffset, panelOffset.Y + yOffset));
                ...
                if (selectedBaseGameObject is IDestroyable selectedDestroyable)
                {
                    ...
                    dc.DrawText(hitpointText, new Point(panelOffset.X + xOffset, panelOffset.Y + yOffset));
                    ...
                    if (selectedDestroyable is ICombat selectedCombat)
                    {
                        if (selectedCombat.GetMeleeAttack() > 0)
                        {
                            ...
                            dc.DrawText(meleeAttackText, new Point(panelOffset.X + xOffset, panelOffset.Y + yOffset));
                        ...
                        if (selectedCombat.GetPierceAttack() > 0)
                        {
                            ...
                            dc.DrawText(pierceAttackText, new Point(panelOffset.X + xOffset, panelOffset.Y + yOffset));
                        ...
                        if (selectedCombat.GetBlastRadius() > 0)
                        {
                            ...
                            dc.DrawText(blastRadiusText, new Point(panelOffset.X + xOffset, panelOffset.Y + yOffset));
                        ...
                        if (selectedCombat.GetMeleeArmor() > 0)
                        {
                            ...
                            dc.DrawText(meleeArmorText, new Point(panelOffset.X + xOffset, panelOffset.Y + yOffset));
                        ...
                        if (selectedCombat.GetPierceArmor() > 0)
                        {
                            ...
                            dc.DrawText(pierceArmorText, new Point(panelOffset.X + xOffset, panelOffset.Y + yOffset));
                        ...
                        if (selectedCombat is IRangedCombat selectedRangedCombat)
                        {
                            if (selectedRangedCombat.GetAttackRangeMax() > 0)
                            {
                                ...
                                dc.DrawText(rangeText, new Point(panelOffset.X + xOffset, panelOffset.Y + yOffset));
                ...
                if (selectedBaseGameObject is IActionable selectedActionable && selectedActionable.GetAction() is Gather selectedActionableGatherAction && !selectedActionableGatherAction.Completed())
                {
                    ...
                    dc.DrawText(gatherActionText, new Point(panelOffset.X + xOffset, panelOffset.Y + yOffset));
                ...
                if (selectedBaseGameObject is IConstructable selectedConstructable && selectedConstructable.GetConstructionTime() > 0)
                {
                    ...
                    dc.DrawText(constructionTimeText, new Point(panelOffset.X + xOffset, panelOffset.Y + yOffset));
                    //yOffset += hitpointText.Height;
                }
            }
        }
