...
namespace AoE.GameObjects.Units.Siege
{
    ...
    {
        public BombardCannon(Vector position, Player owner) : base(position, 18f, 18f, "Bombard Cannon", 80, 40, 0, 0.5f, 6.5f, 5, 12, 0.92f, 4f, 2, 5, 0.7f, 14, "BombardCannon.png", owner)
        {
