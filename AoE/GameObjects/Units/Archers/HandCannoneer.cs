...
namespace AoE.GameObjects.Units.Archers
{
    ...
    {
        public HandCannoneer(Vector position, Team owner) : base(position, 18f, 18f, "Hand Cannoneer", 35, 0, 17, 0f, 3.49f, 0, 7, 0.65f, 5.5f, 1, 0, 0.96f, 9, "HandCannoneer.png", owner)
        {
